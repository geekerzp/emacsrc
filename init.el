...
(when (version< emacs-version "25.0")
  (error "Kitten Emacs requires at least GNU Emacs 25.0, but you're running %s" emacs-version))
...
(kitten/add-subfolders-to-load-path plugins-dir)
...
(custom-set-variables
 ...
 '(custom-safe-themes
   (quote
    ("14f0fbf6f7851bfa60bf1f30347003e2348bf7a1005570fd758133c87dafe08f" "21ebd14a266a6fe91980a5493a411cf6b7f27fd62da2bada897361ab7c4b2a98" default)))
 ...
 '(package-selected-packages
   (quote
    (neotree all-the-icons ranger robe php-mode alchemist csv-mode elixir-mode scss-mode darktooth-theme yaml-mode slim-mode emmet-mode web-beautify yasnippet yari web-mode volatile-highlights undo-tree sr-speedbar smooth-scrolling smartrep smart-mode-line sly-company ruby-tools ruby-end rspec-mode rbenv rainbow-mode rainbow-delimiters pyenv-mode paredit ov operate-on-number nyan-mode move-text magit key-chord json-mode js2-mode irony indent-guide highlight-symbol helm-projectile helm-descbinds helm-ag grizzl god-mode gitignore-mode gitconfig-mode git-timemachine gist findr fic-mode expand-region exec-path-from-shell elisp-slime-nav easy-kill distinguished-theme discover-my-major dired+ diminish diff-hl company-tern company-anaconda coffee-mode cider browse-kill-ring avy auto-compile anzu ag))))
(custom-set-faces
