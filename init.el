...
(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (kaolin-theme apropospriate-theme alect-themes base16-theme intellij-theme gruber-darker-theme all-the-icons-dired plan9-theme gruvbox-theme color-theme-sanityinc-tomorrow solarized-theme dracula-theme distinguished-theme realgud google-c-style autodisass-java-bytecode moe-theme darktooth-theme nubox ujelly-theme spacemacs-theme doom-themes zenburn-theme zerodark-theme nlinum ess nord-theme markdown-mode yari yaml-mode web-mode web-beautify volatile-highlights undo-tree typescript-mode tao-theme spaceline-all-the-icons smartrep sly-company slim-mode scss-mode ruby-tools ruby-end rspec-mode robe rjsx-mode rbenv rainbow-mode rainbow-delimiters pyenv-mode paredit ov operate-on-number move-text meghanada magit key-chord json-mode irony highlight-symbol helm-projectile helm-descbinds helm-ag grizzl god-mode gitignore-mode gitconfig-mode git-timemachine gist findr fic-mode expand-region exec-path-from-shell emmet-mode elisp-slime-nav easy-kill discover-my-major dired+ diminish diff-hl csv-mode company-tern company-anaconda coffee-mode cider browse-kill-ring avy auto-compile anzu alchemist ag)))
