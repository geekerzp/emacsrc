...
(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (spaceline-all-the-icons rjsx-mode yari yaml-mode web-mode web-beautify volatile-highlights undo-tree typescript-mode smartrep sly-company slim-mode scss-mode ruby-tools ruby-end rspec-mode robe rbenv rainbow-mode rainbow-delimiters pyenv-mode paredit ov operate-on-number neotree move-text meghanada magit key-chord json-mode js2-mode irony indent-guide highlight-symbol helm-projectile helm-descbinds helm-ag grizzl god-mode gitignore-mode gitconfig-mode git-timemachine gist findr fic-mode expand-region exec-path-from-shell emmet-mode elisp-slime-nav easy-kill distinguished-theme discover-my-major dired+ diminish diff-hl csv-mode company-tern company-anaconda coffee-mode cider browse-kill-ring avy auto-compile anzu all-the-icons alchemist ag)))
